...
class EDIT_VENDOR_WINDOW(tk.Toplevel):
	...
	#Define EDIT_VENDOR tkinter widgets:
	...
	def search_vendor_data(self):
		...
		#Vendor name selection error message
		if search_vendor_invoice_name == "Select Vendor":

			search_vendor_data_error_message = tk.messagebox.showinfo(title="Error",message="Select a vendor to edit.")
	...
	def change_vendor_data(self):
		...
		#Vendor selection error message:
		if search_vendor_invoice_name == "Select Vendor":

			change_vendor_data_error_message = tk.messagebox.showinfo(title="Error",message="Select a vendor to edit.")
			...
			edit_vendor_confirmation_message = tk.messagebox.showinfo(title="Edit Vendor",message="Changes successful")
