...
class MENU_BAR(tk.Menu):
	...
	def __init__(self,root):
		...
		self.GL_menu.add_command(label="Reconcile General Ledger",command=self.reconcile_GL)
	...
	def reconcile_GL(self):

		if not RECONCILE_GL_WINDOW.alive:

			self.secondary_window = RECONCILE_GL_WINDOW()
